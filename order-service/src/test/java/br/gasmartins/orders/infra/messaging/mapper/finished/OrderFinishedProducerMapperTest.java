...
public class OrderFinishedProducerMapperTest {

    private OrderFinishedProducerMapper mapper;

    @BeforeEach
    public void setup(){
        var itemMapper  = new OrderFinishedItemProducerMapper() ;
        var paymentMethodMapper = new OrderFinishedPaymentMethodProducerMapper() ;
        this.mapper = new OrderFinishedProducerMapper(itemMapper, paymentMethodMapper);
    }
