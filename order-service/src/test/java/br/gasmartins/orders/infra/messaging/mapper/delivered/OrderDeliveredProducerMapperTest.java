...
public class OrderDeliveredProducerMapperTest {

    private OrderDeliveredProducerMapper mapper;

    @BeforeEach
    public void setup(){
        var itemMapper  = new OrderDeliveredItemProducerMapper() ;
        var paymentMethodMapper = new OrderDeliveredPaymentMethodProducerMapper() ;
        this.mapper = new OrderDeliveredProducerMapper(itemMapper, paymentMethodMapper);
    }
