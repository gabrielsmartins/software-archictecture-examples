...
public class OrderConfirmedPaymentMethodProducerMapperTest {

    private OrderConfirmedPaymentMethodProducerMapper mapper;

    @BeforeEach
    public void setup(){
        this.mapper = new OrderConfirmedPaymentMethodProducerMapper();
    }
